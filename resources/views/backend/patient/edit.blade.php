            ...
            <form method="post" action="{{route('patient.update', $data->id)}}">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="address" class="form-control form-control-border" id="exampleInputPassword1" value="{{$data->address}}">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Date Of Birth</label>
                  <input type="date" name="dob" class="form-control form-control-border" id="exampleInputPassword1" value="{{$data->dob}}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select name="trt_id" class="form-control form-control-border">
