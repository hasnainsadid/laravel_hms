  ...
  <div class="container">
    ...
    <div class="owl-carousel wow fadeInUp" id="doctorSlideshow">
          ...
          <div class="card-doctor">
            <div class="header">
              <img src="frontend/assets/img/doctors/doctor_3.jpg" alt="doctor_image">
            </div>
            <div class="body">
              <p class="text-xl mb-0">Dr. Jitu Ibnat</p>
          ...
          <div class="card-doctor">
            <div class="header">
              <img src="frontend/assets/img/doctors/doctor_2.jpg" alt="doctor_image">
            </div>
            <div class="body">
              <p class="text-xl mb-0">Dr. Nazul Islam</p>
              <span class="text-sm text-grey">Hematology</span>
            </div>
          </div>
        </div>
                  <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img src="frontend/assets/img/doctors/doctor_1.jpg" alt="doctor_image">
            </div>
            <div class="body">
              <p class="text-xl mb-0">Dr. Nadia Sultana</p>
          ...
          <div class="card-doctor">
            ...
            <div class="body">
              <p class="text-xl mb-0">Dr. Asma Begum</p>
              <span class="text-sm text-grey">Psychology</span>
            </div>
          </div>
        </div>
                  <div class="item">
          <div class="card-doctor">
            ...
            <div class="body">
              <p class="text-xl mb-0">Dr. Nasrin Jaman</p>
              <span class="text-sm text-grey">Gynaecology</span>
            </div>
          </div>
        </div>
                  <div class="item">
          <div class="card-doctor">
            ...
            <div class="body">
              <p class="text-xl mb-0">Dr. Masum Hossain</p>
          ...
          <div class="card-doctor">
            ...
            <div class="body">
              <p class="text-xl mb-0">Dr. Maleka</p>
              <span class="text-sm text-grey">Neurology</span>
            </div>
          </div>
        </div>
          ...
          <div class="card-doctor">
            ...
            <div class="body">
              <p class="text-xl mb-0">Dr. Humayra</p>
              <span class="text-sm text-grey">Orthopedics</span>
            </div>
          </div>
        </div>
          ...
          <div class="card-doctor">
            ...
            <div class="body">
              <p class="text-xl mb-0">Dr. Shahin Kamal</p>
